...
function verDetalle(idClausula, idTipoClausula) {
    $.get('detalle', {idClausula: idClausula, idTipoClausula: idTipoClausula}, setFormulario);
    activarBloqueoAjax();
}
function verActualizar(idClausula, idTipoClausula) {
    $.get('actualizar', {idClausula: idClausula, idTipoClausula: idTipoClausula}, setFormulario);
    activarBloqueoAjax();
}
function verEliminar(idClausula, idTipoClausula) {
    $.get('eliminar', {idClausula: idClausula, idTipoClausula: idTipoClausula}, setFormulario);
    activarBloqueoAjax();
}
...
function verActualizarMisClausulas(idClausula, desde, idTipoClausula) {
    var idContrato = parseInt($('#idContrato').val());
    var tipoClausula = $('#tipoContrato').val();
    $.get('actualizar', {idClausula: idClausula, idContrato: idContrato, tipoClausula: tipoClausula, idTipoClausula: idTipoClausula}, setFormularioEliminarActulizar);
    activarBloqueoAjax();
}
function verEliminarMisClausulas(idClausula, desde, idTipoClausula) {
    var idContrato = parseInt($('#idContrato').val());
    var tipoClausula = $('#tipoContrato').val();
    $.get('eliminar', {idClausula: idClausula, idContrato: idContrato, tipoClausula: tipoClausula, idTipoClausula: idTipoClausula}, setFormularioEliminarActulizar);
    activarBloqueoAjax();
}
function verDetalleMisClausulas(idClausula, idTipoClausula) {
    var idContrato = parseInt($('#idContrato').val());
    var tipoClausula = $('#tipoContrato').val();
    $.get('detalle', {idClausula: idClausula, idContrato: idContrato, tipoClausula: tipoClausula, idTipoClausula: idTipoClausula}, setFormularioEliminarActulizar);
    activarBloqueoAjax();
}
function copiarSeleccionarClausula(idClausula, desde, idTipoClausula) {
    if (desde === 'copiar') {
        $.get('copiarClausula', {idClausula: idClausula, idTipoClausula: idTipoClausula}, setFormularioEditarClausulas, 'json');
    } else if (desde === 'seleccionar') {
        $.get('copiarClausula', {idClausula: idClausula, idTipoClausula: idTipoClausula}, seleccionarMiClausula, 'json');
    }
}
...
function pegarClausulaNueva() {
    if ($('#tituloNew').val() !== '' && $('#contenidoNew').val() !== '') {
        ...
        if ($('#tituloNew').val() !== $('#tituloNew_' + ids).val()) {
            ...
            $("#predeterminado1").val($('#predeterminado').val());
            $("#tipoClausulaSelect1").val($('#tipoClausulaSelect').val());
