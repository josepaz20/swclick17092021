...
function verServicios(idAntenaTX) {
    $.get("ver-servicios", {idAntenaTX: idAntenaTX}, setFormularioServicio, "json");
    activarBloqueoAjax();
}
...
function setFormularioServicio(respuestaServidor) {
    if (parseInt(respuestaServidor['error']) === 2) {
        alert("NO SE ENCONTRARON SERVICIOS ENGANCHADOS A LA ANTENA.");
        return false;
    }
